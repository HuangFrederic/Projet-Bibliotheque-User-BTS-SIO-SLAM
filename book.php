...
<br><br>
<form method="POST" >
<h3 class="mx-auto p-2">Liste des livres de la bibliothèque:</h3>
...
<thead class="table-dark">
    <tr>
      ...
      <th scope="col" class="w-50" data-sortable="true">Titre du livre</th>
      <th scope="col" class="w-50" data-sortable="true">Auteur</th>
      <th scope="col" class="w-25" data-sortable="true">Disponibilité</th>
    </tr>
  </thead>
  <tbody>
  ...
  ?>
    ...
    <tr>
    <td><img src="<?php echo $livre['image']; ?>" style="max-width: 100px; display: inline-block;"></td>
      <td><?php  echo "<a href='detailsplus.php?id=" . $livre['id_livre'] . "'>" . $livre['titre'] . "</a><br>"; ?></td>
      <?php echo "<td>".$livre['prenom']." ".$livre['nom']."</td>";?>
      <?php echo "<td>".($livre['disponible'] ? 'Disponible' : 'Déjà loué')."</td>";?>
    </tr>
