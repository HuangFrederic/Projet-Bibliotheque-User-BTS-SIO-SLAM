...
<h3 class="mx-auto p-2">Nombre de fois loués:</h3>
<table class="table table-striped table-bordered w-75 mx-auto p-2">
    <thead class="table-dark">
        <tr>
            <th scope="col">Titre du livre</th>
            <th scope="col">Quantité loué</th>
        </tr>
    </thead>
    <tbody>
        <?php
        if ($nbLoue) {
            foreach ($nbLoue as $qttLoue) {
                echo "<tr>";
                echo "<td>" . $qttLoue['titre'] . "</td>";
                echo "<td>" . $qttLoue['nombre_emprunts'] . "</td>";
                echo "</tr>";
            }
        } else {
