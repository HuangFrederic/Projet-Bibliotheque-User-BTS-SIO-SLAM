...
<h3 class="mx-auto p-2">Choisir un livre à rendre :</h3>
...
<div class="mx-auto" style="width: 250px;">
    ...
    <div class="col-sm">
                    <select class="form-control" name="no_book">
                        <?php
                        $tabEmprunt = getAllEmprunt();
                        if(!$tabEmprunt){
                            echo "<option value='null'> Aucun livre à rendre </option>";
                        }
                        else{
                        foreach($tabEmprunt as $key=>$value){
...
<div class="form-group text-center">
    <button type="submit" class="btn btn-primary" name="rendre">Rendre</button>
</div>
