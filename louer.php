...
if (!$tabBook) {
  ...
  $livresDejaLoues = array();
  $livresDejaAffiches = array();
...
<div class="form-row mx-auto" style="width: 500px;">
    <div class="col-sm">
        ...
        <input class="form-control" type="date" name="emprunt" id="emprunt" min="<?php echo date('d-m-y'); ?>" required>
    </div>
    <div class="col-sm">
        <label for="retour">Date de retour :</label>
        <input class="form-control" type="date" name="retour" id="retour" min="<?php echo date('d-m-y'); ?>" required>
    </div>
</div>
