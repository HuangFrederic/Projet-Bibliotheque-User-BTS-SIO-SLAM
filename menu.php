...
<!-- menu -->
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <li class="nav-item">
        <a class="nav-link" href="nb.php">nblivre</a>
      </li>
    </ul>

<!-- bouton chercher -->
<form class="form-inline my-2 my-lg-0" id="find">
      <input class="form-control mr-sm-2" type="search" placeholder="Chercher Livre" aria-label="Search" name="search" id="search">
...
<li class="nav-item dropdown">
    ...
    <button class="dropdown-item" type="button"><a href="nb.php">Nombre des livres loués</a></button>
...
if (isset($_GET['search2'])) {
  ...
  if ($resultats === 'Aucun livre trouvé') {
    echo "<h2 class='mx-auto p-2 text-center fw-bold'>Aucun livre trouvé</h2>";
  }
}
?>
...
<h3 class="mx-auto p-2">Liste des livres loués:</h3>
<table class="table table-striped table-bordered w-75 mx-auto p-2"
id="table" 
  data-toggle="table"
  data-search="true" 
  data-search-align="left px-5"
  data-search-accent-neutralise="true">

<thead class="table-dark">
    <tr>
      <th scope="col"></th>
      <th scope="col" data-sortable="true">Titre du livre</th>
      <th scope="col" data-sortable="true">Auteur</th>
      <th scope="col" data-sortable="true">Date d'emprunt</th>
      <th scope="col" data-sortable="true">Date de retour</th>
    </tr>
  </thead>
  <tbody>

  <?php
    foreach ($tabList as $list): 
  ?>

    <tr>
      <td><img src="<?php echo $list['image']; ?>" style="max-width: 100px; display: inline-block;"></td>
      <td><?php echo "<a href='detailsplus.php?id=" .$list['id_livre'] . "'>" . $list['titre'] . "</a><br>"; ?></td>
      <?php echo "<td>".$list['prenom']." ".$list['nom']."</td>";?>
